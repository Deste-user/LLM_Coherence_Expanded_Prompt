...
if __name__ == '__main__':
    ...
    # ga.create_clipscore_table(avg_clipscores ,models, NUM_CLASS, colors)
    # ga.grafic_avg_time(models, avg_time,colors)
    ga.grafic_cumulative_distribution(models, colors)
    ga.grafic_distribution(models, colors)
